...
pub enum Adjustment {
    ...
    Levels { in_black: f32, in_white: f32, gamma: f32 },
...
impl Adjustment {
    ...
    pub fn encode(&self) -> (u32, [f32; 4]) {
        match *self {
            Adjustment::BrightnessContrast { brightness, contrast } => (1, [brightness, contrast, 0.0, 0.0]),
            Adjustment::Levels { in_black, in_white, gamma } => (2, [in_black, in_white, gamma, 0.0]),
            Adjustment::HueSaturation { hue, saturation, lightness } => (3, [hue, saturation, lightness, 0.0]),
    ...
    pub const DEFAULTS: [Adjustment; 7] = [
        ...
        Adjustment::Levels { in_black: 0.0, in_white: 1.0, gamma: 1.0 },
